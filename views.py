...
#unable to save data of form to the model---probelm no--1
def Contact(request):
	if request.method=="POST":
...
# rooms=[
#     {'id':1,'name':'Django: Python Framework for Web developement'},
#     {'id':3,'name':'LEarn Data Science from zero!'},
#     {'id':4,'name':'Learn GUI By Tkinter'},
#     {'id':5,'name':'Metaverse'},
#     {'id':6,'name':'Metaverse ADV'},
#     ]
